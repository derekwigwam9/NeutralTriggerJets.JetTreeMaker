...
#ifndef StJetTreeMaker_h
#define StJetTreeMaker_h
...
class StJetTreeMaker {
  ...
  public:
    ...
    // ctor, dtor
    StJetTreeMaker(const Bool_t batch=0, TTree *tree=0);
    virtual ~StJetTreeMaker();
  ...
  ClassDef(StJetTreeMaker, 1)

};

#endif
#ifdef StJetTreeMaker_cxx



StJetTreeMaker::StJetTreeMaker(const Bool_t batch, TTree *tree) : _tFemto(0) {
